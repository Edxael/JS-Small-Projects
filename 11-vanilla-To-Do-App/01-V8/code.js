...
var td_obj = {
    ...
    // Button "Display Tasks" Programing
var dispList = document.getElementById("bid0");
dispList.addEventListener("click", function(){ td_obj.displayTD(); });

    // Button "Select All" Programing
var selectAll = document.getElementById("bid2");
selectAll.addEventListener("click", function(){td_obj.chanAll();});
